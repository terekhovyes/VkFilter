package me.alexeyterekhov.circularimageview;
...
public class CircularImageView extends ImageView {
    private float shadowSize = 0.05f;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        float shadow = Math.min(width, height) * shadowSize;
        paintBorder.setShadowLayer(shadow * 2 / 3, 0.0f, shadow * 1 / 3, 0xFF555555);
